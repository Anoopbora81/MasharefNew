package com.sr.masharef.masharef.splash;
...
public class VideoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String lang = settings.getString(Constants.APP_LANGUAGE, "");
...
public class VideoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String uriPath = "android.resource://" + getPackageName() + "/" + R.raw.documentariesandyou;
        Uri uri = Uri.parse(uriPath);
        videoView.setVideoURI(uri);
        videoView.requestFocus();
        mediaController = new
                                                ...
                                                MediaPlayer.OnPreparedListener() {
                                                    ...
                                                    public void onPrepared(MediaPlayer mediaPlayer) {
                                                        ...
                                                        mediaPlayer.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
                                                            @Override
                                                            public void onCompletion(MediaPlayer mediaPlayer) {
                                                                //  videoView.setBackgroundResource(R.drawable.play_button);
                                                               */
/* if (mediaPlayer != null) {
                                                                    mediaPlayer.stop();
//                                                                    mediaPlayer.reset();
//                                                                    mediaPlayer.release();
                                                               ...
                                                               // findViewById(R.id.video_player_bg).setVisibility(View.VISIBLE);
                                                            }
                                                        });
...
//                findViewById(R.id.video_player_bg).setVisibility(View.GONE);
            }
        });
    }
   */
